...
`LORE-AND-WORLD.md` is the canonical editable story and lore source for
ChatGPT-assisted work. It contains the complete setting, history, characters,
main plot, endings, side quests, dialogue direction, chronology, and glossary.

The original formatted reference remains at
`../design/Broken Knight - Lore and World Guide.docx`. Keep it as an archive;
